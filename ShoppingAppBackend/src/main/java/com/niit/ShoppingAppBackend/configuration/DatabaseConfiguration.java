package com.niit.ShoppingAppBackend.configuration;
...
@ComponentScan(basePackages={"com.niit.ShoppingAppBackend.model"})
public class DatabaseConfiguration {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.niit.ShoppingAppBackend.model");
